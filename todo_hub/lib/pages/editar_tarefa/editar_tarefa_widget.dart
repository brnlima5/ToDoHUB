...
class EditarTarefaWidget extends StatefulWidget {
  ...
  final DocumentReference? tarefaRef;
...
class _EditarTarefaWidgetState extends State<EditarTarefaWidget> {
  ...
  void initState() {
    ...
    _model.taskTextController ??=
        TextEditingController(text: widget.nomeTarefa);
    _model.taskFocusNode ??= FocusNode();

    _model.descriptionTextController ??=
        TextEditingController(text: widget.descricaoTarefa);
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('tarefaEditada');

                        await widget.tarefaRef!.update(createTarefasRecordData(
